...
# # Octilinear Polygon 1 (Bottom-left, "staircase" shape)
# poly1 = Polygon([
#     Point(6, 6),
#     Point(18, 6),
#     Point(18, 12),
...
# # Octilinear Polygon 2 (Bottom-right, "notched rectangle")
# poly2 = Polygon([
#     Point(40, 8),
#     Point(56, 8),
#     Point(56, 20),
...
# # Octilinear Polygon 3 (Top-center, "arrow" shape)
# poly3 = Polygon([
#     Point(28, 40),
#     Point(36, 40),
#     Point(36, 48),
...
#     octagon = Polygon([
#         Point(4, 2), Point(6, 2), Point(8, 4), 
#         Point(8, 6), Point(6, 8), Point(4, 8),
#         Point(2, 6), Point(2, 4)
#     ])
    
#     # Create a smaller rectangle
#     rectangle = Polygon([
#         Point(2, 10), Point(14, 10),
#         Point(14, 12), Point(2, 12)
#     ])
#     octagon2 = Polygon([
#         Point(12, 6),
#         Point(12, 10),
...
#     rectangle1 = Polygon([
#         Point(2, 5), Point(2, 25),
#         Point(30, 25), Point(30, 5)
#     ])
#     # Create mesh (U=16 means domain is [0,16]×[0,16])
#     mesh = create_mesh([rectangle1],48)
    
#     # Plot the result
#     mesh.plot([rectangle1])
